...
class CreateCampaignModal extends Component {
  ...
  render() {
    ...
    const { fields, min_end_date, errors } = this.state;
    return (
      <React.Fragment>
        <Modal
          id="myModal"
          ...
          <Modal.Body>
            <form onSubmit={this.handleSubmit} autoComplete="off">
                ...
                <div className="input-wrap-second">
                  ...
                  <div className="group-wrap last">
                    <div className="form-group select-down">
                      ...
                      <select id="contact_list_id" onChange={this.onChange}>
                  ...
                  <div className="select-custom-wrap">
                    ...
                    >
                      <option value="">Select Schedule Time</option>
                       {this.callDrop((moment(this.state.selectedDate).format("YYYY-MM-DD HH:mm")),30)}
                    </select>
                  </div>
              ...
              <div className="calendar-wrap">
                <Calendar onChange={this.changeDate} minDate={new Date()} />
              </div>
